...
public class CsBoardJdbcDao implements CsBoardDao {
	...
	public List<CsBoard> getBoardInfoByNo(int userNo) throws SQLException {
		String sql = "select C.cs_board_no, C.cs_board_title, C.user_no, U.user_name, C.cs_board_view_count, "
					+ "C.cs_board_like_count, C.cs_created_date, C.cs_reply_check "
					+ "from cs_board D, user_table U "
