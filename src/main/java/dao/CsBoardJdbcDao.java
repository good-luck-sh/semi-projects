...
public class CsBoardJdbcDao implements CsBoardDao {
	...
	public List<CsBoard> getAllcsBoardById(int userNo, int begin, int end) throws SQLException {
		List<CsBoard> csBoards = new ArrayList<>();
		String sql = "cs_board_no, cs_board_title, user_no, cs_board_view_count, cs_board_like_count, cs_board_content, cs_created_date, "
				...
				+ "(select row_number() over(order by by C.cs_board_no desc) rn,"
