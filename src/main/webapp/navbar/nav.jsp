...
%>      
                    ...
                    <li class="nav-li"><a href="http://localhost/semi-projects/catelist.jsp"><img src="../navbar/resource/ico_headhm.png" alt="" class="userIcon <%="login".equals(menu) ? "active" : "" %>"id="icon-3" ></a></li>
