...
%>      
                    ...
                    <li><a href="http://localhost/semi-projects/user/mycslist.jsp"><img src="../navbar/resource/ico_headsearch.png" alt="" class="userIcon <%="login".equals(menu) ? "active" : "" %>"id="icon-2" ></a></li>
