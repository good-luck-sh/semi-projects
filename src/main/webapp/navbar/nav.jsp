...
%>          
					<li><a href="/semi-app/main/loginform.jsp" class="btn btn-primary btn-sm<%="login".equals(menu) ? "active" : "" %>">login</a></li>
                    <!-- 로그인이 안되어 있으면 활성화 시켜서 로그인 jsp로 이동하도록 입력한다. -->
                    <li><a href="/semi-app/main/registerform.jsp" class="btn btn-secondary btn-sm<%="register".equals(menu) ? "active" : "" %>">join</a></li>
...
%>      
                    ...
                    <li><a href=""><img src="../navbar/resource/ico_headsearch.png" alt="" class="userIcon <%="login".equals(menu) ? "active" : "" %>"></a></li>
                    <!-- 로그인이 되어있으면 활성화 시켜서 cs게시판 jsp로 이동하도록 입력한다. -->
                    <li><a href=""><img src="../navbar/resource/ico_headhm.png" alt="" class="userIcon <%="login".equals(menu) ? "active" : "" %>"></a>
                  	
                	<!-- 로그인이 되어있지 않으면 icon을 누르면 카테고리의 별 상품정보가 출력되도록 한다.  -->
                	<li><a href="/semi-app/main/logout.jsp" class="nav-link">로그아웃</a></li>
<%
	}
%>
                 </ul>
